...
namespace TidepoolToNightScoutSync.BL.Extensions
{
    ...
    {
        public static IServiceCollection AddTidepoolToNightScoutSyncer(this IServiceCollection services, Action<TidepoolToNightScoutSyncerOptions, IConfiguration> configureOptions)
        {
        ...
        public static IServiceCollection AddNightscoutClient(this IServiceCollection services, Action<NightscoutClientOptions, IConfiguration> configureOptions)
        {
